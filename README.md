...
**Solution:** build data-processing workflows that normalize these sources into application-ready structures for map, dashboard, chart, and export workflows.
...
**Solution:** integrate model/forecast outputs into lake-level views and analytical workflows instead of leaving them as external files.
...
Interactive map for exploring Maine lake polygons, selecting lakes, and opening lake-level environmental data.



### Lake Dashboard

![Lake dashboard](images/maine-lakes-lake-page-dashboard-1.png)
![Lake dashboard](images/maine-lakes-lake-page-dashboard-2.png)
![Lake dashboard](images/maine-lakes-spatial-overview.png)
![Lake dashboard](images/maine-lakes-lake-dashboard-1.png)
![Lake dashboard](images/maine-lakes-lake-dashboard-2.png)
![Lake dashboard](images/maine-lakes-lake-dashboard-3.png)
![Lake dashboard](images/maine-lakes-lake-dashboard-satellite-data-charts-4.png)
![Lake dashboard](images/maine-lakes-lake-dashboard-forecasts-5.png)

Per-lake dashboard showing water-quality indicators, historical field records, satellite-derived values, and lake-level context.
...
Ranked comparison and spatial analysis workflows for comparing lakes and indicators.

### Forecast / Weather View

![Forecast view](images/maine-lakes-forecast-view.png)

Forecast and meteorological data exposed through lake-level web workflows.
...
* Built in collaboration with Dr. Ofir Tal and Prof. Emmanuel Boss; credited as Full-Stack Architect & Platform Developer on the live platform.
...
* Python/FastAPI backend and data workflows.
